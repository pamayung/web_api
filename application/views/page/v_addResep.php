...
<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
            Resep Makanan
            <small>add Resep</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Add Resep</li>
        </ol>
    </section>
            ...
            <div class='col-md-12'>
                <div class='box box-info'>
                    <div class='box box-info'>
                        ...
                        <!-- form start -->
                        <?php echo form_open_multipart('addResep/insert'); ?>
                        <div class="box-body">
                            <div class="form-group">
                                <label>Nama Resep</label>
                                <input name="nama_resep" type="text" class="form-control"placeholder="Enter resep">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input name="video" type="text" class="form-control" placeholder="Enter Link">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="bahan" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
                                </textarea>
                            </div>
                            <div class="form-group">
                                <label>Langkah-Langkah</label>
                                <textarea name="langkah" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
                                </textarea>
                            </div>
                            <div class="form-group">
