...
class AddKomentar extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('page/v_addKomentar', $data);
    }
    ...
    public function insert() {
        ...
        if ($_FILES['gambar_komentar']['name']) {
            if ($this->upload->do_upload('gambar_komentar')) {
                $fto = $this->upload->data();
                $data = array(
                    'gambar_komentar' => base_url('assets/hasil_resize/' . $fto['file_name']),
                    'nama_komentar' => $this->input->post('nama_komentar'),
                    'komentar' => $this->input->post('komentar'),
                );
//                print_r($data);exit();

                $this->model->simpan('komentar', $data);
                ...
                redirect('komentar'); //jika berhasil maka akan ditampilkan view upload
            } else {
                ...
                redirect('addKomentar'); //jika gagal maka akan ditampilkan form upload
            }
        }
    }
