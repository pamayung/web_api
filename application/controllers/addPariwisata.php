...
class AddPariwisata extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('page/v_addPariwisata');
    }
    ...
    public function insert() {
        ...
        if ($_FILES['foto']['name']) {
            if ($this->upload->do_upload('foto')) {
                ...
                $latlong['latitude'] = $this->input->post('latitude');
                $latlong['longitude'] = $this->input->post('longitude');
                $latlng = implode(',', $latlong);
//                print_r($latlng);
//                exit();
                $data = array(
                    'foto' => base_url('assets/hasil_resize/' . $fto['file_name']),
...
//                print_r($data);exit();
                ...
                $this->model->simpan('pariwisata', $data);
                ...
                redirect('pariwisata'); //jika berhasil maka akan ditampilkan view upload
            } else {
                ...
                redirect('addPariwisata'); //jika gagal maka akan ditampilkan form upload
            }
        }
    }
